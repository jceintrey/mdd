 ...
 * <p>
 * This class stores and provides access to user-related details. It is used by Spring Security for
 * authentication and authorization, as well as by {@code UserManagementService} for user management
...
public class AppUserDetails implements UserDetails {
     ...
     * <p>
     * Currently, this method returns a default role {@code "ROLE_USER"}. In the future, it should
     * be updated to fetch roles dynamically from the database, ideally using a dedicated roles
     * table.
     * </p>
     * 

 ...
 *
 * This class sets up HTTP security, authentication mechanisms, and JWT integration to secure the
 * API. It leverages stateless session management and customizes the {@link SecurityFilterChain} to
...
public class SpringSecurityConfig {
        ...
        private static final String[] AUTH_WHITELIST =
                        {"/api/auth/login", "/api/auth/register", "/swagger-ui/**",
                                        "/v3/api-docs/**"
        ...
        /**
         * Configures the {@link SecurityFilterChain} bean, overiding default security rules applied
         * to HTTP requests.
         * <p>
         * This configuration: - Disables CSRF protection (may need to be adjusted for specific use
         * cases). - Permits access to the {@link AUTH_WHITELIST} URL without authentication. -
         * Requires authentication for all other requests. - Configures Spring Security to act as an
        ...
        /**
         * This bean is requierd by Spring security and provides a {@link PasswordEncoder} to use
        ...
        /**
         * Configures the Spring Security {@link AuthenticationManager} bean, which is responsible
        ...
        /**
         * Configures global CORS settings to allow frontend requests from localhost:4200.
         *
         * <p>
         * Allows all paths (/**) to accept cross-origin requests from the frontend dev server with
